...
function KantinBalwil1(){
    return (
        <>
            ...
            detailReview= "Makanannya enak, nasinya pulen dan hangat, ayam nya empuk, bumbunya pun enak, karedok nya dengan bumbu kacang enak, sayur taugenya pun segar. Makanannya enak, nasinya pulen dan hangat, ayam nya empuk, bumbunya pun enak, karedok nya dengan bumbu kacang enak, sayur taugenya pun segar. karbohidrat: nasi, mie, kentang, tempe. protein: ayam, telur, tahu, tempe. lemak: minyak yang ada dalam masakan. vitamin: tumis sayur, sayur asem, lalapan. mineral: sayuran, telur asin, kaldu dari masakan. serat: tumis sayur, sup, tempe"
            bgSrc={foto}
            makanan1="Ayam"
            makanan2="Kentang"
            makanan3="Tempe"
