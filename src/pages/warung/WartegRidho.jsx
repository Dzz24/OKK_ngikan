...
function WartegRidho(){
    return (
        <>
            ...
            detailReview= "Makanannya enak, bumbunya terasa pas dan tidak berlebihan. Ususnya empuk, telur dan kangkungnya segar. Semua rasa berpadu dengan baik, dan porsinya pas untuk makan siang yang praktis dan mengenyangkan. Tempatnya cukup sempit tetapi terjaga kebersihannya. Suasana di sini nyaman, cocok untuk makan santai. Terdapat meja yang cukup banyak, jadi kita tidak perlu khawatir jika datang saat jam makan ramai.Karbohidrat: Nasi. Protein: Telur, usus. Lemak: Usus. Vitamin dan Serat: Kangkung"
            bgSrc={foto}
            makanan1="Telur"
            makanan2="Usus"
            makanan3="Kangkung"
